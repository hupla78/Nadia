      ...
      <p id="pani">
       ...
       <div class="large-12  medium-12  small-12 columns margin-menu">
         ...
         <li class="menud large-3 small-6 medium-3 columns separbot">
               <div class="panel">
                 <?php echo $this->Html->link('Produits',array('controller'=>'pages','action'=>'home', ),array('class'=>'pi-text-center'))?>  
               </div>
        ...
        <li class="menud large-3 small-6 medium-3 columns separbot">
               <div class="panel">
                 <?php echo $this->Html->link('Fil de Boheme',array('controller'=>'pages','action'=>'home', ),array('class'=>'pi-text-center'))?>  
               </div>
        ...
        <li class="menud large-3 small-6 medium-3 columns separbot">
               <div class="panel">
                 <?php echo $this->Html->link('Actualité',array('controller'=>'pages','action'=>'home', ),array('class'=>'pi-text-center'))?>  
               </div>
        ...
        <li class="menud large-3 small-6 medium-3 columns separbot">
               <div class="panel">
                 <?php echo $this->Html->link('Points de vente',array('controller'=>'pages','action'=>'home', ),array('class'=>'pi-text-center'))?>  
               </div>
	...
	<?php echo $this->fetch('content'); ?>	
		...
		<div id="footer">
			...
			<?php echo $this->Html->link(
					...
					array('target' => '_blank', 'escape' => false, 'class' => 'lien lolo')
				);
				?>
				</div>
