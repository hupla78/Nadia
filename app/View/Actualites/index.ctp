<div class="actualites index">
	...
	<tr>
		...
		<td><?php echo h($actualite['Actualite']['text']); ?>&nbsp;</td>
		<td><?php echo h($actualite['Actualite']['image_id']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $actualite['Actualite']['id']), array(), __('Are you sure you want to delete # %s?', $actualite['Actualite']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
