...
<?php echo $this->Form->create('AdressePofile'); ?>
	<fieldset>
		<legend><?php echo __('Edit Adresse Pofile'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AdressePofile.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('AdressePofile.id'))); ?></li>
