...
--
-- Host: localhost
-- Generation Time: May 14, 2015 at 12:38 PM
...
--
-- Table structure for table `panier_commands`
--

CREATE TABLE IF NOT EXISTS `panier_commands` (
  `id` int(11) NOT NULL,
  `created` datetime NOT NULL,
  `updated` datetime NOT NULL,
  `user_id` int(11) NOT NULL,
  `adresse_pofile_id` int(11) NOT NULL,
  `state` varchar(20) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `panier_commands`
--

INSERT INTO `panier_commands` (`id`, `created`, `updated`, `user_id`, `adresse_pofile_id`, `state`) VALUES
(19, '2015-03-21 10:22:38', '2015-03-21 10:22:38', 43, 6, 'votre commande a éte'),
(20, '2015-03-21 10:27:10', '2015-03-21 10:27:10', 43, 6, 'votre commande a éte'),
(21, '2015-03-21 10:31:03', '2015-03-21 10:31:03', 43, 6, 'votre commande a éte'),
(22, '2015-03-21 10:31:04', '2015-03-21 10:31:04', 43, 6, 'votre commande a éte'),
(23, '2015-03-21 10:31:04', '2015-03-21 10:31:04', 43, 6, 'votre commande a éte'),
(24, '2015-03-21 10:33:37', '2015-03-21 10:33:37', 43, 6, 'votre commande a éte'),
(25, '2015-03-21 10:34:31', '2015-03-21 10:34:31', 43, 6, ''),
(26, '2015-03-21 10:35:36', '2015-03-21 10:35:36', 43, 6, ''),
(34, '2015-03-21 10:41:53', '2015-03-21 10:41:53', 43, 6, ''),
(35, '2015-03-21 10:42:07', '2015-03-21 10:42:07', 43, 6, 'votre commande a éte'),
(36, '2015-04-19 10:57:37', '2015-04-19 10:57:37', 0, 0, 'votre commande a éte'),
(37, '2015-04-19 11:00:44', '2015-04-19 11:00:44', 0, 0, 'votre commande a éte'),
(38, '2015-04-19 11:02:19', '2015-04-19 11:02:19', 0, 0, 'votre commande a éte'),
(39, '2015-04-21 10:29:18', '2015-04-21 10:29:18', 43, 6, ''),
(40, '2015-04-21 10:33:26', '2015-04-21 10:33:26', 43, 6, ''),
(41, '2015-04-21 11:15:20', '2015-04-21 11:15:20', 43, 6, ''),
(42, '2015-04-21 14:59:52', '2015-04-21 14:59:52', 43, 6, ''),
(43, '2015-04-21 15:00:37', '2015-04-21 15:00:37', 43, 6, ''),
(44, '2015-04-21 16:36:50', '2015-04-21 16:36:50', 43, 6, ''),
(45, '2015-04-21 16:42:10', '2015-04-21 16:42:10', 43, 6, ''),
(46, '2015-04-25 08:55:29', '2015-04-25 08:55:29', 43, 6, ''),
(47, '2015-04-25 09:07:28', '2015-04-25 09:07:28', 43, 6, ''),
(48, '2015-04-25 09:10:21', '2015-04-25 09:10:21', 43, 6, ''),
(49, '2015-04-25 09:10:31', '2015-04-25 09:10:31', 43, 6, ''),
(50, '2015-04-25 13:45:02', '2015-04-25 13:45:02', 43, 6, ''),
(51, '2015-04-25 13:45:31', '2015-04-25 13:45:31', 43, 6, ''),
(52, '2015-04-25 13:46:06', '2015-04-25 13:46:06', 43, 6, ''),
(53, '2015-04-25 13:46:48', '2015-04-25 13:46:48', 43, 6, ''),
(54, '2015-04-25 13:49:23', '2015-04-25 13:49:23', 43, 6, ''),
(55, '2015-04-26 11:59:02', '2015-04-26 11:59:02', 43, 6, ''),
(56, '2015-04-26 12:00:34', '2015-04-26 12:00:34', 43, 6, ''),
(57, '2015-04-26 12:01:31', '2015-04-26 12:01:31', 43, 6, ''),
(58, '2015-04-26 12:59:41', '2015-04-26 12:59:41', 43, 6, ''),
(59, '2015-04-26 15:21:13', '2015-04-26 15:21:13', 43, 6, ''),
(60, '2015-04-26 16:10:42', '2015-04-26 16:10:42', 43, 6, '');

-- --------------------------------------------------------

--
-- Table structure for table `panier_ventes`
--

CREATE TABLE IF NOT EXISTS `panier_ventes` (
  `id` int(11) NOT NULL,
  `article_id` int(11) NOT NULL,
  `panier_command_id` int(11) NOT NULL,
  `q` int(11) NOT NULL,
  `p` double NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `panier_ventes`
--

INSERT INTO `panier_ventes` (`id`, `article_id`, `panier_command_id`, `q`, `p`) VALUES
(1, 1, 34, 2, 50),
(2, 3, 34, 1, 32),
(3, 1, 35, 2, 50),
(4, 3, 35, 1, 32),
